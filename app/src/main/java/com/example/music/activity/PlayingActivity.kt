...
class PlayingActivity : AppCompatActivity() {
    ...
    //初始化控件资源
//    fun initViews() {
//        iv_background.setImageResource(R.drawable.back)
//        iv_song_cover.setImageResource(R.drawable.disk)
...
//    }
    ...
    fun initPop(){
        ...
        mPopupWindow = PopupWindow(mRootView,ViewGroup.LayoutParams.MATCH_PARENT,(getScreeHeight()*0.6).toInt())
        mPopupWindow.apply {
            isFocusable = true
    ...
    fun initClick() {
        ...
        //底部弹出播放列表
        iv_open_songs.setOnClickListener {
            reduceTransparency()
